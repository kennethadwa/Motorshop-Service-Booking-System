                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-6 text-md-end"> <!-- Align text to the end on larger screens -->
                                    <!-- Add Employee Button -->
                                    <button class="btn btn-primary" onclick="window.location.href='add_employee.php'">
                            ...
                            <div class="table-responsive"> <!-- Makes table responsive -->
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        // Fetch employee data
                                        $sql = "SELECT employee_id, first_name, last_name, contact_no, email, account_type, profile FROM employees";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                $email = $row['email'];
                                                $account_type = $row['account_type'] == 1 ? '<span style="color: green;">Employee</span>' : 'Other';
                                                ...
                                                echo "<tr>
                                                        ...
                                                        <td>$account_type</td>
                                                        <td>
                                                            <a class='action-btn btn btn-info' href='view_employee.php?id=$employee_id'>
