                    ...
                    <div class="card">
                        <div class="card-body row justify-content-center">
                            ...
                            <div class="col-12 text-center mt-4">
                                ...
                                <a href="update_employee_account.php?id=<?php echo $employee_id; ?>" class="btn btn-success action-btn"><i class="fa-solid fa-pencil" style="color: #ffffff;"></i> Update</a>
                                <a href="delete_employee.php?id=<?php echo $employee_id; ?>" class="btn btn-danger action-btn" onclick="return confirm('Are you sure you want to delete this employee?')"><i class="fa-solid fa-trash" style="color: #ffffff;"></i> Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
