                    ...
                    <div class="card" style="box-shadow: 1px 1px 10px black; background: transparent;">
                        <div class="card-body row justify-content-center">
                            ...
                            <div class="col-12 text-center mt-4">
                                <a href="manage-account.php" class="btn action-btn" style="box-shadow: none; border: none; background: orange; color: white"> <i class="fas fa-arrow-left"></i> Back</a>

                                <a href="update_employee_account.php?id=<?php echo $employee_id; ?>" class="btn btn-success action-btn" style="box-shadow: none; border: none; background: green; color: white"><i class="fa-solid fa-pen-nib" style="color: #ffffff;"></i> Update</a>

                                <a href="delete_employee.php?id=<?php echo $employee_id; ?>" class="btn action-btn" onclick="return confirm('Are you sure you want to delete this employee?')" style="color:white; background: red;"><i class="fa-solid fa-trash" style="color: #ffffff; "></i> Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
