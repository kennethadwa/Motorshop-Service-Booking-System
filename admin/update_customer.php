                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" style="background-color: transparent; color: white;" value="<?php echo $row['first_name']; ?>" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="last_name">Last Name:</label>
                                <input type="text" name="last_name" style="background-color: transparent; color: white;" value="<?php echo $row['last_name']; ?>" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="age">Age:</label>
                                <input type="number" name="age" style="background-color: transparent; color: white;" value="<?php echo isset($row['age']) ? $row['age'] : ''; ?>" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="birthday">Birthday:</label>
                                <input type="date" name="birthday" style="background-color: transparent; color: white;" value="<?php echo isset($row['birthday']) ? $row['birthday'] : ''; ?>" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_no" style="background-color: transparent; color: white;" value="<?php echo $contact_no; ?>" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="address">Address:</label>
                                <input type="text" name="address" style="background-color: transparent; color: white;" value="<?php echo $address; ?>" class="form-control" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="text-center">
                                <a href="view_customer?id=<?php echo $customer_id; ?>" class="btn" style="box-shadow: none; border: none; background: orange; color: white;"><i class="fas fa-arrow-left"></i> Back</a>
