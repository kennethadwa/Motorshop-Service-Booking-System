                    ...
                    <div class="card-body">
                        ...
                        <form action="update_profile_process.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" style="background-color: transparent; color: white;" value="<?php echo $row['first_name']; ?>" class="form-control" >
                            </div>
                            <div class="form-group">
                                <label for="last_name">Last Name:</label>
                                <input type="text" name="last_name" style="background-color: transparent; color: white;" value="<?php echo $row['last_name']; ?>" class="form-control" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="birthday" style="background-color: transparent; color: white;" value="<?php echo $birthday; ?>" class="form-control" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="text-center">
                                ...
                                &nbsp;
                                <button type="submit" class="btn" style="box-shadow: none; border: none; color: white; background: green;"><i class="fa-solid fa-pen-nib" style="color: #ffffff;"></i> Update</button>
                            </div>
