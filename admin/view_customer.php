                    ...
                    <div class="card" style="box-shadow: 1px 1px 10px black; background: transparent;">
                        <div class="card-body row justify-content-center">
                            ...
                            <div class="col-12 text-center mt-4">
                                ...
                                <a href="update_customer?id=<?php echo $customer_id; ?>" class="btn action-btn" style="box-shadow: none; border: none; background: green; color: white;"><i class="fa-solid fa-pen-nib" style="color: #ffffff;"></i> Update</a>
                                <a href="delete_customer?id=<?php echo $customer_id; ?>" class="btn action-btn" style="box-shadow: none; border: none; background: red; color: white;"><i class="fa-solid fa-trash" style="color: #ffffff;"></i> Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
