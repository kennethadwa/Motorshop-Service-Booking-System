...
<div class="form-container sign-in">
  <form action="auth-login.php" method="post">
    ...
    <div class="social-icons">
      <a href="<?php echo htmlspecialchars($googleLoginUrl); ?>" class="icon" style="width: auto; height: auto; background: white; color: black; padding: 5px; font-weight: 500; font-size: 1rem;"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
